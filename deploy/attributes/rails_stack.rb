...
when "nginx_rainbows"
  normal[:opsworks][:rails_stack][:recipe] = "rainbows::rails"
  normal[:opsworks][:rails_stack][:needs_reload] = true
  normal[:opsworks][:rails_stack][:service] = 'rainbows'
  normal[:opsworks][:rails_stack][:restart_command] = '../../shared/scripts/rainbows clean-restart'
else
